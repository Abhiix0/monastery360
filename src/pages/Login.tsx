  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (loginForm.email && loginForm.password) {
        localStorage.setItem("monastery360_user", JSON.stringify({
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to Monastery360. Your spiritual journey begins now.",
      });
          ...
          <div className="monastery-card p-8">
            ...
            {isLogin ? (
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    to="/forgot-password" 
                    className="text-sm text-japanese-carmine hover:text-sinopia transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
                ...
                <div>
                  <label className="flex items-start gap-3">
                    ...
                    <span className="text-sm monastery-text-secondary leading-relaxed">
                      I agree to the{" "}
                      <Link to="/terms" className="text-japanese-carmine hover:text-sinopia">
                        Terms of Service
                      </Link>{" "}
                      and{" "}
                      <Link to="/privacy" className="text-japanese-carmine hover:text-sinopia">
                        Privacy Policy
                      </Link>
                    </span>
                  </label>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button className="w-full inline-flex justify-center py-2.5 px-4 border monastery-border rounded-xl shadow-sm bg-white text-sm font-medium monastery-text-secondary hover:bg-straw/10 transition-colors">
